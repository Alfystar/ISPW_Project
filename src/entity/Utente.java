...
public class Utente {
    ...
    {
        String out;
        out="Utente nick: "+ this.pubD.getNick().get()+", Email:"+this.pubD.getEmail().get()+", CF:"+ this.pubD.getFiscalCode().get()+"\n";
        out+="\t##PublicData##\n"+ this.pubD.toString();
        out+="\t##PrivateData##\n"+ this.prD.toString();
        out+="\t##Ruolo##\n"+this.roles;
    ...
    {
        return "UserNick: "+ this.pubD.getNick().get()+", Email:"+this.pubD.getEmail().get()+", CF:"+ this.pubD.getFiscalCode().get()+"\n";
    }
